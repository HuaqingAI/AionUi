...
const INSTALLER_ERROR_SCENARIOS = [
  {
    ...
    code: 'E1001',
    message: '华青智能助手 could not repair the installed uninstaller.',
    action: 'Close 华青智能助手, restart Windows if needed, then run this installer again.',
    diagnostics:
  ...
  },
  {
    ...
    code: 'E1002',
    message: 'The previous 华青智能助手 uninstaller returned an error.',
    action:
  ...
  },
  {
    ...
    code: 'E1003',
    message: '华青智能助手 could not remove or replace the previous installation directory.',
    action: 'Close 华青智能助手 and any program using the install folder, then run this installer again.',
  ...
  },
  {
    ...
    code: 'E1020',
    message: '华青智能助手 cannot continue because the target disk does not have enough free space.',
  ...
  },
  {
    ...
    code: 'E1030',
    message: '华青智能助手 installed, but the bundled AionCore resources are incomplete.',
    action: 'Download a fresh installer and run it again.',
  ...
  },
  {
    ...
    code: 'E1031',
    message: '华青智能助手 installation is incomplete because a required application file is missing.',
    action: 'Reinstall 华青智能助手 or download a newer installer.',
  ...
  },
  {
    ...
    action: 'Download the 华青智能助手 installer that matches this Windows architecture, then run it again.',
  ...
  },
  {
    ...
    code: 'E1050',
    message: 'Another 华青智能助手 installer appears to still be active.',
  ...
  },
  {
    ...
    code: 'E1060',
    message: '华青智能助手 found an invalid previous-install registry state.',
    action: 'Uninstall the old 华青智能助手 from Windows Settings, then run this installer again.',
  ...
  },
  {
    ...
    code: 'E1070',
    message: '华青智能助手 could not write the active-installer marker.',
...
function Find-FailureWindow([string]$Code, [int]$TimeoutSec = 90) {
  ...
  do {
    ...
    foreach ($window in $windows) {
      ...
      if ($text -like "*华青智能助手 installation failed ($Code)*" -or
...
try {
  ...
  foreach ($required in @(
    "华青智能助手 installation failed ($Code)",
    "scenario=$ScenarioId",
    'Suggested action:',
    'Diagnostics:',
    'Installer log:',
...
function createHarnessNsi({ exePath, logPath, projectRoot, scenario }) {
  ...
  return `
Unicode true
Name "华青智能助手 Failure MessageBox Smoke"
...
Section
  StrCpy $INSTDIR "$TEMP\\华青智能助手-messagebox-smoke"
  ...
  try {
    ...
    if (autoDecline) {
      ...
      if (autoDecline === 'consent') {
        ...
        if (typeof status.copyText !== 'string' || !status.copyText.includes(`华青智能助手 installer failure ${code}`)) {
