 ...
 *   - macOS:   ~/Library/Logs/HQBuddy/YYYY/MM/DD/YYYY-MM-DD.log
 *   - Windows: %USERPROFILE%\AppData\Roaming\HQBuddy\logs\YYYY\MM\DD\YYYY-MM-DD.log
 *   - Linux:   ~/.config/HQBuddy/logs/YYYY/MM/DD/YYYY-MM-DD.log
 *
