...
import { Computer, Info, Puzzle, Toolkit } from '@icon-park/react';
 ...
 */
export type BuiltinSettingTab = 'model' | 'agent' | 'tools' | 'system' | 'about';
 ...
 * ```
 */
const SettingsModal: React.FC<SettingsModalProps> = ({ visible, onCancel, defaultTab = 'tools' }) => {
